...
{
	Vector3 cs_size = Vector3(font_size / m_ScreenSize.x, font_size / m_ScreenSize.y, 0.0f);
...
{
	float cs_size_x = STATUS_TEXT_SIZE / m_ScreenSize.x * 2.0f;
	float cs_size_y = STATUS_TEXT_SIZE / m_ScreenSize.y * 2.0f;
...
{
	//Draw log text
	float cs_size_x = LOG_TEXT_SIZE / m_ScreenSize.x * 2.0f;
	float cs_size_y = LOG_TEXT_SIZE / m_ScreenSize.y * 2.0f;
	...
	float aspectRatio = m_ScreenSize.y / m_ScreenSize.x;
