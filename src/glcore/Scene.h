...
public:
	...
	virtual void OnSceneResize(int width, int height)		{}			//Called when the scene is active and the window has resized (in case the scene needs to rebuild FBO's etc)
